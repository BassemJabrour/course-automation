          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                One plan. Lifetime access to every AI automation lesson, template, and bonus.
              </p>
            </div>
            <div className="grid gap-6 md:grid-cols-[1.2fr_1fr] items-center">
              ...
              <div className="text-center md:text-right">
                <div className="text-5xl font-extrabold mb-2">$147</div>
                <p className="text-sm text-green-600 dark:text-green-400 font-medium mb-6">
                  One-time payment • Lifetime access
                </p>
                <a
                  href={SALES_URL}
                  className="inline-flex items-center justify-center w-full md:w-auto h-12 px-6 rounded-lg bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold text-lg hover:opacity-90 transition shadow-lg"
                >
                  Get Started with Complete Bundle
                </a>
